...
export abstract class IMutation {
    ...
    abstract createCharacter(input?: Nullable<NewCharacter>): Character | Promise<Character>;

    abstract createFavorites(input?: Nullable<NewFavoritesList>): FavoritesList | Promise<FavoritesList>;

    abstract createLocation(input?: Nullable<NewLocation>): Location | Promise<Location>;
